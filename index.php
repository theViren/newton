<?php
    ...
    {
    $inputFileName = 'Excel/information.xlsx';
    $spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load($inputFileName);
    $sheet = $spreadsheet->getActiveSheet();

    $row = $sheet->getHighestRow()+1;
    $sheet->insertNewRowBefore($row);
    $sheet->setCellValue('A'.$row, $_POST['name']);
    $sheet->setCellValue('B'.$row, $_POST['email']);

    $writer = new Xlsx($spreadsheet);
    $writer->save('Excel/information.xlsx');
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="login-form-inner">
                ...
                <form action="" method="post">
                    <div class="login-form-group">
                        ...
                        <input autocomplete="off" type="text" placeholder="Enter Name" id="name" name="name" />
                    </div>
                    <div class="login-form-group">
                    ...
                    <input type="submit" class="rounded-button login-cta" name="submit" value="Register" />
                </form>
            </div>
